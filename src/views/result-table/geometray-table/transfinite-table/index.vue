    ...
    <n-card v-if="showSearchForm" :bordered="true" class="card-style">
      ...
      >
        <NGrid :cols="4" :x-gap="12" :y-gap="8">
          <NFormItemGi label="标识位置">
            <NInput v-model:value="searchForm.mileage" placeholder="请输入标识位置" clearable />
          </NFormItemGi>
          <NFormItemGi label="线路特征">
            <NInput v-model:value="searchForm.operators" placeholder="请输入线路特征" clearable />
          </NFormItemGi>
          <NFormItemGi label="检测时间">
            <NInput v-model:value="searchForm.inspectionTime" placeholder="请输入检测时间" clearable />
          </NFormItemGi>
          <NFormItemGi label="负责人员">
            <NInput v-model:value="searchForm.responsiblePerson" placeholder="请输入负责人员" clearable />
          </NFormItemGi>
          <NFormItemGi label="轨距超限峰值">
            <NInput v-model:value="searchForm.gaugeMeasured" placeholder="请输入轨距超限峰值" clearable />
          </NFormItemGi>
          <!-- <n-form-item-gi label="轨距变化率">
                    <n-input v-model:value="searchForm.gaugeChangeRateMeasured" placeholder="请输入轨距变化率" clearable />
                </n-form-item-gi> -->
          <NFormItemGi label="水平超限峰值">
            <NInput v-model:value="searchForm.levelMeasured" placeholder="请输入水平超限峰值" clearable />
          </NFormItemGi>
          <NFormItemGi>
            <NSpace>
