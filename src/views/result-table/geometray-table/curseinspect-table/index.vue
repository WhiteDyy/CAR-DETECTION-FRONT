<template>
  <CommonPage>
    ...
    <NCard v-if="showSearchForm" :bordered="true" class="card-style">
      <NForm :model="inspectionInfo" label-placement="left" label-width="auto">
        <NGrid :cols="5" :x-gap="12" :y-gap="8">
          ...
          <NGridItem>
            <NFormItem label="检查人员">
              <NInput v-model:value="inspectionInfo.inspector" placeholder="请输入检查人员" clearable />
            </NFormItem>
          </NGridItem>
          <NGridItem>
            <NFormItem label="线路名称">
              <NInput v-model:value="inspectionInfo.lineName" placeholder="请输入线路名称" clearable />
            </NFormItem>
          </NGridItem>
          <NGridItem>
            <NFormItem label="序号">
              <NInput v-model:value="inspectionInfo.number" placeholder="请输入序号" clearable />
            </NFormItem>
          </NGridItem>
          <!-- <n-grid-item>
