<template>
  <CommonPage>
    ...
    <n-card v-if="showSearchForm" :bordered="true" class="card-style">
      ...
      >
        <NGrid :cols="4" :x-gap="12" :y-gap="8">
          <NFormItemGi label="编号">
            <NInput v-model:value="searchForm.number" placeholder="请输入编号" clearable />
          </NFormItemGi>
          <NFormItemGi label="位置">
            <NInput v-model:value="searchForm.direction" placeholder="请输入位置" clearable />
          </NFormItemGi>
          <NFormItemGi label="标准值">
            <NInput v-model:value="searchForm.standardValue" placeholder="请输入标准值" clearable />
          </NFormItemGi>
          <NFormItemGi label="实际值">
            <NInput v-model:value="searchForm.measurementValue" placeholder="请输入实际值" clearable />
          </NFormItemGi>
          <NFormItemGi>
            <NSpace>
    ...
    <NDataTable
      :columns="columns" :data="dataTable" :bordered="true"
