    ...
    <div>
      <NCard class="image-card">
        <div class="header-content">
          ...
          <n-tag size="large" type="info" class="switch-info">
            第1道岔 - 60kg/m 12号道岔
          </n-tag>
      ...
      <NCard class="table-card">
        <NDataTable :bordered="true" :striped="true" :columns="columns" :data="tableData" />
      </NCard>
    </div>
  </CommonPage>
</template>
...
const imageSrc = new URL('@/assets/images/switch4.jpg', import.meta.url).href
