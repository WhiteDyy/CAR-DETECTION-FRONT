        ...
        <div>
            <n-card class="image-card">
                <div class="header-content">
                    <n-button class="switch-btn" @click="switchData('prev')">
                        <template #icon>
                            <n-icon>
                                <ArrowBackIosRound />
                            </n-icon>
                    ...
                    <n-button class="switch-btn" @click="switchData('next')">
                        下一组
                        <template #icon>
                            <n-icon>
                ...
                <div class="canvas-container">
                    <canvas ref="canvasRef" class="turnout-canvas"></canvas>
                </div>

                <div class="table-container">
                    <n-data-table :columns="columns" :data="tableData" :row-key="(row) => row.ruler"
...
import { NDataTable, NCard, NTag, NButton, NSpace } from 'naive-ui';
...
// 计算从圆点到卡片的路径
const calculatePath = (startPos, endPos, id, ctx) => {
    // 虚线样式
    ctx.setLineDash([5, 2]);
