        ...
        <NCard title="道岔设计工具" style="margin-top: 20px;">
          <NSpace vertical>
            ...
            <NSpace align="center">
              ...
              <NSelect
                v-model:value="newArea.type" :options="areaTypes" style="width: 120px;"
                placeholder="区域类型"
              />
              <NInputNumber
                v-model:value="newArea.mileage" placeholder="里程(mm)" :min="0"
                style="width: 120px;"
              />
              <NInputNumber
                v-model:value="newArea.gauge" placeholder="轨距(mm)" :min="1000" :max="2000"
                style="width: 120px;"
              />
